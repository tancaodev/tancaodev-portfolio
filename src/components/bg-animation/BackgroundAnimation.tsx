...
const HeroBackgroundAnimation = () => (
    <div className='w-full h-full'>
        <svg className='BgAnimation__svg w-full h-full' viewBox='0 0 602 602' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <g opacity='0.15'>
                <path
                    fillRule='evenodd'
                    clipRule='evenodd'
            ...
            <defs>
                ...
                >
                    <stop offset='0.333333' className='BgAnimation__gradient BgAnimation__gradient-light dark:BgAnimation__gradient-dark' />
