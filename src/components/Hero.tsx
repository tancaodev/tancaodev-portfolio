    ...
    return (
        <section className='pt-32 md:pt-40 pb-20 md:pb-28 container mx-auto'>
            <div className='max-w-3xl mx-auto'>
                <div className='text-sm font-medium text-muted-foreground mb-2'>Hi, my name is</div>
                <h1 className='text-4xl md:text-7xl font-bold mb-6'>Tan Cao</h1>
                ...
                <p className='text-lg text-muted-foreground mb-8 leading-relaxed'>
                    I'm a software engineer specializing in building exceptional digital experiences. Currently, I'm focused on building accessible,
                    human-centered products at a software company.
                </p>
